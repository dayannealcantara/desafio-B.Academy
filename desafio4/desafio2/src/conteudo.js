...
function Conteudo({ title, content }) {
  return (
    <Div>
      ...
      <P>
        Os óleos essenciais são compostos voláteis produzidos pelas plantas para
        a sua sobrevivência, pois são substâncias químicas que exercem as
        funções de defesa e de atração de polinizadores, além de inibir a ação
        de alguns herbívoros. Alguns protegem contra o ataque de bactérias ou
        fungos, outros são conhecidos por serem alelopáticos. Os componentes
        majoritários são os sesquiterpenóides e monoterpenóides, os quais são
        altamente voláteis e contribuem para a fragrância ou essência das
        plantas que os produzem.
      </P>

      <Title size="2"> Alguns Benefícios</Title>
      <P>
        No corpo, por apresentarem funções terapêuticas, farmacológicas e
        cosméticas, os óleos essenciais têm como principais benefícios:
      </P>
      <ul>
